  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="sticky top-24 z-20 mb-8 p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg rounded-xl shadow-md border border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-grow">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500 bg-white/70 dark:bg-gray-700/70 dark:text-white"
              />
            ...
            <div className="flex-shrink-0 flex items-center gap-2 overflow-x-auto pb-2 md:pb-0">
              {FILTERS.map(filter => (
                <button
                  key={filter}
                  ...
                  className={`px-4 py-2 text-sm font-semibold rounded-full transition-colors whitespace-nowrap ${
                    activeFilter === filter
                      ...
                      : 'bg-gray-100/70 dark:bg-gray-700/70 text-gray-700 dark:text-gray-300 hover:bg-gray-200/80 dark:hover:bg-gray-600/80'
                  }`}
                >
                  {filter}
                </button>
